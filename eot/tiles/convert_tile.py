...
from eot.tiles.read_write_tile import read_image_tile_from_file


def convert_tile_pixel_to_location(tile, dx, dy):
...
def read_image_tile_if_available(tile, tile_to_tile_fp, bands):
...
def create_image_metatile(tile, tile_list, bands):
    ...
    ul = read_image_tile_if_available(ul, tile_to_tile_fp, bands)
    uc = read_image_tile_if_available(uc, tile_to_tile_fp, bands)
    ur = read_image_tile_if_available(ur, tile_to_tile_fp, bands)
    cl = read_image_tile_if_available(cl, tile_to_tile_fp, bands)
    cc = read_image_tile_if_available(tile, tile_to_tile_fp, bands)
    cr = read_image_tile_if_available(cr, tile_to_tile_fp, bands)
    bl = read_image_tile_if_available(bl, tile_to_tile_fp, bands)
    bc = read_image_tile_if_available(bc, tile_to_tile_fp, bands)
    br = read_image_tile_if_available(br, tile_to_tile_fp, bands)
